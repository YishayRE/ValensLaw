      ...
      $("body").queryLoader2({
        ...
        onComplete: function () {
          ...
          for(var i = 0; i < numChars; i++){
            ...
            if (i == (numChars-1)){
              tlSplitText.to(author, 2, {delay: 0, y: '10px', opacity: 0, onComplete:a1}, "-=3");
          ...
          $('html.no-touch .split-text-wrap').each(function () {
            ...
            tltopSplitText.staggerTo($(this).find('.fadespantop'), 0, {className:'+=appear'}, 0.2, "-=1");
            tltopSplitText.staggerTo($(this).find('.fadespan'), 0, {className:'+=appear', onComplete: function(){
                if ($('.fadeVideoUp').length) {
                  $('.fadeVideoUp').addClass('show');
                }
            ...
            for (var r = 0; r < splitObj.length; r++) {
              tltopSplitText.staggerFrom(splitObj[r], 1.5, {opacity: 0, delay: .1 * r}, .04, 0);
