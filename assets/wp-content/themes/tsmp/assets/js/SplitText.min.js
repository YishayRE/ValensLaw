...
!function (e) {
  ...
  var t = e.GreenSockGlobals || e, i = function (e) {
    ...
    C = function (e, t) {
      ...
      var a, h, u, f, c, g, y, x, S, v, b, _, m = l(e), C = d(e, "paddingLeft", m), T = -999,
        ...
        q = s && -1 !== $.indexOf("lines") ? [] : null, z = -1 !== $.indexOf("words"), D = -1 !== $.indexOf("chars"),
        F = "absolute" === t.position || t.absolute === !0, I = t.linesClass, P = -1 !== (I || "").indexOf("++"), Q = [];
      ...
      var l, o, d, p, a, g, _, m, C, T = t.span ? "span" : "div", w = t.type || t.split || "chars,words,lines",
        A = -1 !== w.indexOf("chars"), L = "absolute" === t.position || t.absolute === !0, B = t.wordDelimiter || " ",
        V = " " !== B ? "" : L ? "&#173; " : " ", W = t.span ? "</span>" : "</div>", H = !0, E = r.createElement("div"),
        k = e.parentNode;
  ...
  E.split = function (e) {
    ...
    var t, i, n, s = this.elements.length, r = e.span ? "span" : "div", l = C(e.wordsClass, r), o = C(e.charsClass, r);
